...
public class QuestionDAO {
    ...
    public static List<QuestionPojo> getQuestionPaperByJob(String jobId) throws SQLException{
        Connection conn=DBconnection.getConnection();
    ...
    public static boolean editQuestionPaper(List<QuestionPojo> questionList) throws SQLException{
        Connection conn=DBconnection.getConnection();
        PreparedStatement ps=conn.prepareStatement("update sys.questions set questions = ?,option1=?,option2=?,option3=?,option4=?,correctoption=? where jobid=? and qno=?");
        int count=0;
