 ...
 * @author aadarsh jain
 */
public class AdminViewAllSelectedStudentFrame extends javax.swing.JFrame {

    /**
     * Creates new form AdminViewAllSelectedStudentFrame
     */
     private DefaultTableModel model;
    private List<ParticipantsPojo> allSelectedStudentsList;
    public AdminViewAllSelectedStudentFrame() {
        initComponents();
         this.setLocationRelativeTo(null);
        lblName.setText(CurrentUser.getName());
        model=(DefaultTableModel)tblAllSelectedStudents.getModel();
        loadSelectedStudentsDetails();
    }

     public void loadSelectedStudentsDetails(){
        try{
            allSelectedStudentsList=ParticipantsDAO.getSelectedStudents();
            for(ParticipantsPojo stu:allSelectedStudentsList){
            ...
            if(allSelectedStudentsList.isEmpty()){
    ...
    private void initComponents() {
        ...
        tblAllSelectedStudents = new javax.swing.JTable();
        ...
        tblAllSelectedStudents.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tblAllSelectedStudents);
        ...
        jLabel4.setText("All Selected Students -");
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 240, 190, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminViewAllSelectedStudentFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tblAllSelectedStudents;
